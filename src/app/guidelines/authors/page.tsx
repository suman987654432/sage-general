    ...
    <div>
      <div className="container mx-auto px-4 py-8 mt-16 flex flex-col items-center">
        ...
        <div className="max-w-6xl w-full mt-6">
          ...
          <p className="mt-4">For assistance or questions, please contact the editorial office at <a href="mailto:mycologicalspectrum@gmail.com" className="underline text-primary-black-v3">mycologicalspectrum@gmail.com</a>.</p>
        <p className="mt-5">Updated as of 16 May 2025</p>
        </div>
      </div>
